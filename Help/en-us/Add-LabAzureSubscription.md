...
PS C:\> New-LabDefinition -Name SomeLab -DefaultVirtualizationEngine Azure
PS C:\> Add-LabAzureSubscription -DefaultLocationName 'West Europe'
```

Adds the default subscription of the Azure account that has been connected to the lab definition
