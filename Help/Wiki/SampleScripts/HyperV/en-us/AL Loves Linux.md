# HyperV - AL Loves Linux

This sample lab is pretty standard apart from different Linux flavours in
the lab. Both CentOS and Open SuSE Clients are deployed and if possible
PowerShell is installed on said clients.
