...
This sample script deploys two labs, one on HyperV, one on Azure. After that,
Connect-Lab is used to connect both labs using a Site to Site VPN and the appropriate
gateways on-premises and on Azure.
