...
$importFolders = Get-ChildItem "$PSScriptRoot\.." -Include Types, Public, Private, Snippets -Recurse -Directory -ErrorAction SilentlyContinue
...
$sb.ToString() | Set-Content "$PSScriptRoot\..\AutomatedLab.Recipe.psm1"

Update-ModuleManifest -Path "$PSScriptRoot\..\AutomatedLab.Recipe.psd1" -FunctionsToExport $publicList
