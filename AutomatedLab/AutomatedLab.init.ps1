...
Set-PSFConfig -Module 'AutomatedLab' -Name WinRmMaxConcurrentOperations -Value 4294967295 -Validation integerpositive -Initialize -Description 'CAREFUL! Fiddling with the defaults will likely result in errors if you do not know what you are doing! Configure a different number of overall concurrent operations on all lab machines if necessary.'
