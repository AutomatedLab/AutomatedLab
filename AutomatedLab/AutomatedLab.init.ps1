...
# SCVMM
Set-PSFConfig -Module 'AutomatedLab' -Name SqlOdbc -Value 'https://download.microsoft.com/download/5/7/2/57249A3A-19D6-4901-ACCE-80924ABEB267/ENU/x64/msodbcsql.msi'
...
Set-PSFConfig -Module AutomatedLab -Name ValidationSettings -Value @{
    ...
    MandatoryRoleProperties = @{
        ...
        Scvmm2016 = @('ProductKey')
        Scvmm2019 = @('ProductKey')
    }
