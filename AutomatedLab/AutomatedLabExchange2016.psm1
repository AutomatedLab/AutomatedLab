...
function Install-LabExchange2016
{
    ...
    param (
        ...
        [switch]$CopyExchange2016InstallationFiles,
    ...
    $exchangeServers = Get-LabVM -Role Exchange2016
    ...
    $exchangeRootDomains = (Get-LabVM -Role Exchange2016).DomainName | Sort-Object -Unique | ForEach-Object {
    ...
    if ($CopyExchange2016InstallationFiles -or $All)
    { 
