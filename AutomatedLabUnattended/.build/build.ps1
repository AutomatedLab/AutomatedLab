...
$sb.ToString() | Set-Content "$PSScriptRoot\..\AutomatedLabUnattended.psm1"

Update-ModuleManifest -Path "$PSScriptRoot\..\AutomatedLabUnattended.psd1" -FunctionsToExport $publicList
