...
Add-LabMachineDefinition -DomainName contoso.com -Name DC1 -Memory 4GB -OperatingSystem 'Windows Server 2022 Datacenter (Desktop Experience)' -Roles RootDC
...
# Plain SCVMM
Add-LabMachineDefinition -DomainName contoso.com -Name VMM1 -Memory 8GB -OperatingSystem 'Windows Server 2022 Datacenter (Desktop Experience)' -Roles Scvmm2022
...
Add-LabMachineDefinition -DomainName contoso.com -Name VMC1 -Memory 8GB -OperatingSystem 'Windows Server 2022 Datacenter (Desktop Experience)' -Roles $role
Install-Lab
if ($Engine -eq 'Azure')
{
    Stop-LabVm -All
