...
# List
$allLabs = Invoke-RestMethod -Method Get -Uri http://NestedBuilder/Lab
$specificLab = Invoke-RestMethod -Method Get -Uri http://NestedBuilder/Win10 # throws, does not exist yet
...
# Get Status
$labCreationJob = Invoke-RestMethod -Method Get -Uri http://NestedBuilder/Job/$guid

Invoke-RestMethod -Method Get -Uri http://NestedBuilder/Lab/Win10 # Retrieve lab properties

# Remove lab
Invoke-RestMethod -Method Delete -Uri http://NestedBuilder/Lab/Win10
