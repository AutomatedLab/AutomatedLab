...
Set-PSFConfig -Module AutomatedLab -Name ValidationSettings -Value @{
    ValidRoleProperties     = @{
        ...
        FailoverNode             = @{
            'ClusterName' = '[string] The name of the cluster this node should join.'
            'ClusterIP'   = '[string] The IP address of the cluster this node should join.'
        }
        HyperV                   = @{
            ...
            'VirtualMachineMigrationAuthenticationType' = '[Microsoft.HyperV.PowerShell.MigrationAuthenticationType] The authentication type to use for virtual machine migrations.'
            'UseAnyNetworkForMigration'                 = '[bool] Whether to use any network for migration.'
            'VirtualMachineMigrationPerformanceOption'  = '[Microsoft.HyperV.PowerShell.VMMigrationPerformance] The performance option to use for virtual machine migrations.'
        ...
        SQLServer2012            = @{
            'Features'              = '[string[]] The features to install. Possible values are: SQLENGINE, REPLICATION, FULLTEXT, RS, AS, IS, MDS, DQC, CONN, BC, SDK, TOOLS and OCS.'
            'ConfigurationFile'     = '[string] The path to the configuration file.'
            'InstanceName'          = '[string] The name of the SQL Server instance.'
            'Collation'             = '[string] The collation to use for the SQL Server instance.'
            'SQLSvcAccount'         = '[string] The account to use for the SQL Server service.'
            'SQLSvcPassword'        = '[string] The password for the SQL Server service account.'
            'AgtSvcAccount'         = '[string] The account to use for the SQL Server Agent service.'
            'AgtSvcPassword'        = '[string] The password for the SQL Server Agent service account.'
            'RsSvcAccount'          = '[string] The account to use for the SQL Server Reporting Services service.'
            ...
            'AsSvcAccount'          = '[string] The account to use for the SQL Server Analysis Services service.'
            'AsSvcPassword'         = '[string] The password for the SQL Server Analysis Services service account.'
            'IsSvcAccount'          = '[string] The account to use for the SQL Server Integration Services service.'
